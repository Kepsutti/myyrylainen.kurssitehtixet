...
namespace vk2.Controllers
{
    ...
    public class ItemsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public Task<Item> GetItem(Guid id, Guid playerId)
        {
        ...
        [HttpGet]
        public Task</*Item[]*/List<Item>> GetAllItems(Guid playerId)
        {
        ...
        [HttpPut("{id}")]
        public Task<Item> ModifyItem(Guid id, ModifiedItem item, Guid playerId)
        {
        ...
        [HttpDelete("{id}")]
        public Task<Item> DeleteItem(Guid id, Guid playerId)
        {
